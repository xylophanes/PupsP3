...
gcc -w -Wfatal-errors -O3 -o iscard iscard.c											>>& $logFile
if($status != 0) then
	echo ""															>>& $logFile
...
gcc -w -Wfatal-errors -O3 -o ishex ishex.c  >>& $logFile
if($status != 0) then
        echo ""                                                                                 				>>& $logFile
...
gcc -w -Wfatal-errors -O3 -o isint isint.c  											>>& $logFile
if($status != 0) then
        echo ""                                                                                 				>>& $logFile
...
gcc -w -Wfatal-errors -O3 -o suffix  suffix.c     										>>& $logFile
if($status != 0) then
        echo ""                                              		                                                   	>>& $logFile
...
gcc -w -Wfatal-errors -O3 -o prefix  prefix.c     										>>& $logFile
if($status != 0) then
        exit -1
endif
...
if($buildtype == cluster) then
    ...
    echo ""															>>& $logFile
    echo "    ... Building (checks if process is P3 aware)"									>>& $logFile
    echo ""															>>& $logFile
    ...
    echo ""															>>& $logFile
    gcc -w -Wfatal-errors -D$utarget -D$arch -DSSH_SUPPORT -O3 -I../include.libs -o gob gob.c  					>>& $logFile
    if($status != 0) then
        echo ""                                                                                                                 >>& $logFile
