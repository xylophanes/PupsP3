...
{   int i;
    ...
    { 
       ...
       #ifdef PTHREAD_SUPPORT
       (void)pupsthread_mutex_lock(&nodelist->nodes[i]->mutex);
       #endif /* PTHREAD_SUPPORT */
       ...
       {  
          ...
          #ifdef PTHREAD_SUPPORT
          (void)pupsthread_mutex_unlock(&nodelist->nodes[i]->mutex);
          #endif /* PTHREAD_SUPPORT */
...
{   if(node == (node_type *)NULL)
    ...
    (void)pupsthread_mutex_lock(&node->mutex);
    ...
    { 
       ...
       #ifdef PTHREAD_SUPPORT
       (void)pupsthread_mutex_unlock(&node->mutex);
       #endif /* PTHREAD_SUPPORT */
...
{   int i;
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_lock(&nodelist->mutex);
    #endif /* PTHREAD_SUPPORT */
    ...
    {  if(nodelist->nodes[i] != (node_type *)NULL && (nodelist->nodes[i] = (node_type *)cantor_pointer_live(nodelist->nodes[i],TRUE)))
          ...
          { 
             ...
             #ifdef PTHREAD_SUPPORT
             (void)pupsthread_mutex_unlock(&nodelist->mutex);
             #endif /* PTHREAD_SUPPORT */
...
{   int link_index;
    ...
    {  node->link_alloc            = ALLOC_QUANTUM;
       ...
       { 
          ...
          #ifdef PTHREAD_SUPPORT
          (void)pupsthread_mutex_unlock(&link->mutex);
          #endif /* PTHREAD_SUPPORT */
...
{   if(link == (link_type *)NULL)
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_lock(&link->mutex);
    #endif /* PTHREAD_SUPPORT */
...
{   int i,
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_lock(&from->mutex);
    (void)pupsthread_mutex_lock(&to->mutex);
    #endif /* PTHREAD_SUPPORT */
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_unlock(&from->mutex);
    (void)pupsthread_mutex_unlock(&to->mutex);
    #endif /* PTHREAD_SUPPORT */
...
{   int i,
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_lock(&n1->mutex);
    (void)pupsthread_mutex_lock(&n2->mutex);
    #endif /* PTHREAD_SUPPORT */
    ...
    if(matched != n1->object_cnt && matched != n2->object_cnt)
    {
       ...
       #ifdef PTHREAD_SUPPORT
       (void)pupsthread_mutex_unlock(&n1->mutex);
       (void)pupsthread_mutex_unlock(&n2->mutex);
       #endif /* PTHREAD_SUPPORT */
...
{   if(object == (object_type *)NULL)
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_lock(&object->mutex);
    #endif /* PTHREAD_SUPPORT */
    ...
    else if(hdes > 0)
    {
       ...
       #ifdef PTHREAD_SUPPORT
       (void)pupsthread_mutex_unlock(&object->mutex);
       #endif /* PTHREAD_SUPPORT */
...
{  int i,
   ...
   { 
      ...
      #ifdef PTHREAD_SUPPORT
      (void)pupsthread_mutex_lock(&links[i]->mutex);
      #endif /* PTHREAD_SUPPORT */
      ...
      #ifdef PTHREAD_SUPPORT
      (void)pupsthread_mutex_unlock(&links[i]->mutex);
      #endif /* PTHREAD_SUPPORT */
...
{   int i;
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_lock(&link_1->mutex);
    (void)pupsthread_mutex_lock(&link_2->mutex);
    (void)pupsthread_mutex_lock(&link_3->mutex);
    #endif /* PTHREAD_SUPPORT */
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_unlock(&link_1->mutex);
    (void)pupsthread_mutex_unlock(&link_2->mutex);
    (void)pupsthread_mutex_unlock(&link_3->mutex);
    #endif /* PTHREAD_SUPPORT */
...
{   int i;
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_lock(&node_1->mutex);
    (void)pupsthread_mutex_lock(&node_2->mutex);
    (void)pupsthread_mutex_lock(&node_3->mutex);
    #endif /* PTHREAD_SUPPORT */
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_unlock(&node_1->mutex);
    (void)pupsthread_mutex_unlock(&node_2->mutex);
    (void)pupsthread_mutex_unlock(&node_3->mutex);
    #endif /* PTHREAD_SUPPORT */
...
{   int i;
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_lock(&nodelist_1->mutex);
    (void)pupsthread_mutex_lock(&nodelist_2->mutex);
    (void)pupsthread_mutex_lock(&nodelist_3->mutex);
    #endif /* PTHREAD_SUPPORT */
    ...
    #ifdef PTHREAD_SUPPORT
    (void)pupsthread_mutex_unlock(&nodelist_1->mutex);
    (void)pupsthread_mutex_unlock(&nodelist_2->mutex);
    (void)pupsthread_mutex_unlock(&nodelist_3->mutex);
    #endif /* PTHREAD_SUPPORT */
