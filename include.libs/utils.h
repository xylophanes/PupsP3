...
#define CKPT_INCREMENTAL    1
#define CKPT_EXIT           2 
#define CKPT_VERBOSE        4
#define CKPT_WRAP_FILES     8
#define CKPT_CHILDREN       16
...
#define PUPS_FILE_COPY      1
#define PUPS_FILE_MOVE      2
...
#define NONE                (1 << 0) 
#define PRINT_ERROR_STRING  (1 << 1) 
#define EXIT_ON_ERROR       (1 << 2) 
#define CHILD_EXIT_ON_ERROR (1 << 3) 
...
#define RESET_MSTREXT      '*',(char *)NULL,(char *)NULL
...
_EXPORT char *version,                    // Version of program
	     ...
	     *appl_home,                  // Effective home directory
             ...
             *args[255];                  // Secondry argument vectors
...
_PROTOTYPE _EXPORT int strand(const _BOOLEAN, const size_t, char *);
...
// Get (named) file lock
_PROTOTYPE _EXPORT _BOOLEAN get_lock(const char *, const int);
...
_PROTOTYPE _EXPORT void pups_wait_until_file_loaded(const int);
...
_PROTOTYPE _EXPORT void pups_fdes_set_stable(void);

// Reset file content stability flag
_PROTOTYPE _EXPORT void pups_fdes_reset_stable(void);
...
_PROTOTYPE _EXPORT _BOOLEAN pups_is_in_container(void);
...
_PUBLIC size_t strlcat(char *, const char *, size_t dsize);

// Open BSD strlcpy functiom
_PUBLIC size_t strlcpy(char *, const char *, size_t dsize);
