...
#define PUPS_NOAUTO_CLEAN     (1 << 8) // Don't automatically wait for child
#define PUPS_OBITUARY         (1 << 9) // Log death of child process


#define MAX_TIMEOUTS  3                // Maximum number of timeouts
#define SCAN_TIMEOUT  300              // Timeout quantum
#define TIME_PERIOD   600              // srvcap re-read period in seconds
#define CPU_HUGE_LOAD 1000.0           // Force server to bottom of table
