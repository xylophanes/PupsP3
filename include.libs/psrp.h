...
#define WEB_FACE                       (1 << 3)  /* PSRP requests via HTTP          */
                                                 /*---------------------------------*/
...
/*-------------------------------------------*/
/* Max threads on PSRP server                */
/*-------------------------------------------*/

//#define PSRP_MAX_THREADS              128
...
#define PSRP_RECURSIVE                 (1 << 5) 
#define PSRP_NOTRAIL                   (1 << 6) 
...
#define PSRP_PROTOCOL_VERSION          7.03 
#define PSRP_BAG_PAGE_SIZE             512
#define PSRP_DISPATCH_PAGE_SIZE        32
#define PSRP_ALLOCATION_QUANTUM        32
...
#define PSRP_STDIO_ASSIGNED            6
#define PSRP_RECONNECT_STDIO           7
#define PSRP_REDIRECT_STDIO            8
...
_PROTOTYPE _EXPORT int psrp_register_on_abort(const void *);

// Callback function for client side abort
_PROTOTYPE _EXPORT void (*on_abort)(void);
...
_PROTOTYPE _EXPORT int psrp_get_server_host(FILE *, char *, char [][256]);
